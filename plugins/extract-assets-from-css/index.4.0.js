    ...
    compiler.plugin("emit",function(compilation,callback){
        ...
        for(var str in indexAssets){
            ...
            source.replace(cssReg,function(){
                ...
                var newCssUrl = "";
                //将需要提取的资源路径前加上php变量
                var cssTarget = cssStr.replace(assetsReg,function(str){totalCssTarget+=str.replace(new RegExp(that.publicPathReg,"g"),that.phpStr);return ""});
                //以新的css文件重新生产hash值
            ...
            var crossOriginStr = 'document.createElement=(function(){const fn=document.createElement.bind(document);return function(type,none){const result=fn(type);if(type==="script"&&!none){result.crossOrigin="anonymous"}return result}})();'
            ...
            compilation.assets[newPath] = {source:function(){return jsStr},size:function(){return jsStr.length}};
